...
def account_confirmation(obj):
    send_mail(
        ...
        message='Добро пожаловать! Вы зарегистрировались на нашей платформе - интернет-магазина "SkyStore".\n'
        f'Для подтверждения регистрации перейдите по ссылке: http://127.0.0.1:8000/users/activate/{obj.token}\n'
        'Если вы не регистрируетесь на "SkyStore", просто не обращайте внимания на это письмо.\n'
